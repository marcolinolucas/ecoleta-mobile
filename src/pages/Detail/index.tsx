...
import { getPointDetail } from '../../services/EcoletaService';
...
const Detail = () => {
	...
	const [pointDetail, setPointDetail] = useState<Point>({} as Point);

	useEffect(() => {
		async function setPointDetailAsync() {
			setPointDetail(await getPointDetail({ id: pointId }));
		}
	...
	if (!pointDetail.point) return null;
		...
		<>
			<View style={styles.container}>
				...
				<Image
					...
					source={{ uri: pointDetail.point.imageUrl }}
				/>
			...
			<View style={styles.footer}>
				...
				<RectButton style={styles.button}>
					...
					<Text style={styles.buttonText} onPress={handleComposeMail}>E-mail</Text>
				</RectButton>
			</View>
		</>
	)
